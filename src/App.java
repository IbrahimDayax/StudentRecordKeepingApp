/**
 * @author Ibrahim Dayah Abdullahi   Title: Student Record Keeping App
 * 
 * Date: 6/04/2022
 */
...
//Student Class that defines the necessary data of every student that is to be stored in the system
class Student {
